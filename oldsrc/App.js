    ...
    return (
      <div className="app-container">
        ...
        <div className="content-container">
          <Slide left>
            <div
              style={{ background: this.state.leftColor }}
              className="left-container"
            >
              {this.state.display === "splash" ? (
              ...
              {this.state.display === "sat-gen" ? (
                <a
                  target="_blank"
                  href="https://enigmatic-escarpment-97432.herokuapp.com/"
                >
              ...
              {this.state.display === "haoly" ? (
                <a
                  target="_blank"
                  href="https://zachherwitz.github.io/chineseapp/"
                >
          ...
          <Slide right>
            <div
              style={{ background: this.state.rightColor }}
            ...
            >
                ...
                <div>
                  ...
                  {this.state.showResume ? (
                    ...
                    <div className="bio">
                      ...
                      <p>
                        a curious, detail oriented developer with an eye for
                        team dynamics and a desire to pop the hood and get my
                        hands dirty. I bring the drive, stamina, and
                        communication skills needed to succeed both in sprints
                        and marathons. As someone who has worked their way up
                        through the film industry and the New York night life
                        scene, I am a self starter that can lead by example, or
                        elevate a team through collaboration!
                      </p>
                    </div>
                  )}
                </div>
              ...
              {this.state.display === "distro" ? (
                <ProjectDescription
                  ...
                  projectInfo="A film-facing team management and distribution app."
                />
              ) : null}
              ...
              {this.state.display === "sat-gen" ? (
                <ProjectDescription
                  ...
                  projectInfo="Full CRUD on a question database and generator for quick SAT prep. Created with Hannah Livnat."
                />
              ) : null}
              ...
              {this.state.display === "rootstock" ? (
                <ProjectDescription
                  ...
                  projectInfo="Financial portfolio manager with comprehensive charts and live stock updates. Created with John Sweriduk and Adlan Yandarbiev"
                />
              ) : null}
              ...
              {this.state.display === "distro-ejs" ? (
                <ProjectDescription
                  ...
                  projectInfo="A campy and user-friendly contact management app."
                />
              ) : null}
              ...
              {this.state.display === "haoly" ? (
                <ProjectDescription
                  ...
                  projectInfo="A simple and meditative Chiense dictionary with built-in flashcards"
                />
              ) : null}
            </div>
          </Slide>
